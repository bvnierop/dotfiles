...
#+begin_src emacs-lisp
  (use-feature eglot
    ...
    (defun eglot-csharp--server-file ()
      ...
      (expand-file-name (concat eglot-csharp-install-dir "OmniSharp")))
    ...
    (defun eglot-csharp--install (version)
      ...
      (let ((url (format "https://github.com/OmniSharp/omnisharp-roslyn/releases/download/%s/omnisharp-linux-x64-net6.0.zip"
                         version))
